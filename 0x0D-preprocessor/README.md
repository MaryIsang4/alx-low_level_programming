I have learnt about common predefined macros in C while practicing how to implement micros and include guard header files as well as the differences between static and dynamic libraries.
